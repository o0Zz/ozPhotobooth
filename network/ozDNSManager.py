...
class DNSHandler(socketserver.BaseRequestHandler):
    def handle(self):
        ...
        for question in all_questions:
            ...
            logger.debug("DNSRequest {} -> {}".format(name, IP))
...
class ozDNSManager(threading.Thread):
	...
	def Start(self):
		try:
			...
			self.mServer = socketserver.ThreadingUDPServer(("", 53), DNSHandler)
		except:
			logger.error("Unable to start DNS Server !")
			return False
